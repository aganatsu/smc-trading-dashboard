...
export default function ChartView() {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-full">
      {/* TradingView Chart */}
      <div className={`${panelOpen ? 'w-full md:w-[65%]' : 'w-full'} h-[60%] md:h-full relative transition-all duration-200`}>
        {/* Timeframe bar */}
      ...
      {/* Analysis Panels */}
      {panelOpen && (
        <div className="w-full md:w-[35%] h-[40%] md:h-full border-t md:border-t-0 md:border-l border-border bg-card overflow-y-auto">
          {/* Market Bias */}
          <AccordionPanel
            id="bias"
            title="Market Bias"
