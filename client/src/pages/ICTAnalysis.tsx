...
export default function ICTAnalysis() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full overflow-hidden">
      ...
      <div className="md:hidden flex-shrink-0 border-b border-border bg-card overflow-x-auto">
        <div className="flex gap-1 px-2 py-2">
          {SYMBOLS.map((sym) => (
            <button
              key={sym}
              onClick={() => setSelectedSymbol(sym)}
              className={`flex-shrink-0 px-2.5 py-1 text-[10px] font-mono font-bold rounded transition-colors ${
                selectedSymbol === sym
      ...
      {/* Desktop: Vertical symbol sidebar */}
